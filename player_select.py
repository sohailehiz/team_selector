...
colstep4.text("Click on Button to Generate Captain and Player Numbers")
colstep4.text("Team Captain 1 can pick his/her Players based on the football Type")
colstep4.text("Team Captain 2 Can ONLY pick his/her Players after Team Captain 1 [Option will be available then]")
